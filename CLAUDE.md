...
- REQ-001: Generous white space; no page should feel cluttered
- REQ-002: All pages match homepage styling (typography, colors, component patterns)
- REQ-003: Primary CTA = discovery call with free process audit; feature proprietary tools
